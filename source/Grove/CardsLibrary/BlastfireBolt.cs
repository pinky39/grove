    ...
    public class BlastfireBolt : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .FlavorText("\"Encase yourself in the most elaborate armor, and cower behind the heaviest shield. I would hate for you to feel helpless.\"{EOL}—Korig the Ruiner")
                .Cast(p =>
                {
                    p.Effect = () => new CompoundEffect(
                        new DealDamageToTargets(5),
                        new DestroyAllPermanents((e, c) => e.Target.Card().Attachments.Contains(c)));
