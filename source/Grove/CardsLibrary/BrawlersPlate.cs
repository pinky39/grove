    ...
    public class BrawlersPlate : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .Text("Equipped creature gets +2/+2 and has trample.{I}(If it would assign enough damage to its blockers to destroy them, you may have it assign the rest of its damage to defending player or planeswalker.){/I}{EOL}Equip{4} {I}({4}: Attach to target creature you control. Equip only as a sorcery.){/I}")
