    ...
    public class SatyrWayfinder : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
              ...
              .TriggeredAbility(p =>
              {
                  p.Text = "When Satyr Wayfinder enters the battlefield, reveal the top four cards of your library. You may put a land card from among them into your hand. Put the rest into your graveyard.";

                  p.Trigger(new OnZoneChanged(to: Zone.Battlefield));

                  p.Effect = () => new RevealTopCardsPutLandInHandOthersOnGraveyard(4);
              });
        }
    }
}
