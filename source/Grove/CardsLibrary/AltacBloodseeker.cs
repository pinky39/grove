  ...
  public class AltacBloodseeker : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
          ...
          .Text("Whenever a creature an opponent controls dies, Altac Bloodseeker gets +2/+0 and gains first strike and haste until end of turn.{I}(It deals combat damage before creatures without first strike, and it can attack and {T} as soon as it comes under your control.){/I}")
          .Power(2)
          .Toughness(1)
          .TriggeredAbility(p =>
          {
