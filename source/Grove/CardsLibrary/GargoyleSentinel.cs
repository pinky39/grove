    ...
    public class GargoyleSentinel : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .Text("{Defender}{I}(This creature can't attack.){/I}{EOL}{3}: Until end of turn, Gargoyle Sentinel loses defender and gains flying.")
                .FlavorText("The beating of a gargoyle's wings on the air is like the cracking of stones. Intruders who rouse a gargoyle are certain to hear the cracking of bones.")
                .Power(3)
                .Toughness(3)
