    ...
    public class StormtideLeviathan : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .Text("{Islandwalk}{I}(This creature can't be blocked as long as defending player controls an Island.){/I}{EOL}All lands are Islands in addition to their other types.{EOL}Creatures without flying or islandwalk can't attack.")
                .Power(8)
                .Toughness(8)
                ...
                .ContinuousEffect(p =>
                {
                    ...
                    p.CardFilter = (card, effect) => card.Is().Land && card.Zone == Zone.Battlefield;
                });
        }
    }
}
