    ...
    public class DivineFavor : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .Text("Enchant creature{EOL}When Divine Favor enters the battlefield, you gain 3 life.{EOL}Enchanted creature gets +1/+3.")
                .FlavorText("With an armory of light, even the squire may champion her people.")
                .Cast(p =>
                {
                    p.Effect = () => new Attach(
                        () => new AddPowerAndToughness(1, 3)).SetTags(EffectTag.IncreasePower, EffectTag.IncreasePower);
