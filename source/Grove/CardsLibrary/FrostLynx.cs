    ...
    public class FrostLynx : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
              ...
              .TriggeredAbility(p =>
              {
                  p.Text = "When Frost Lynx enters the battlefield, tap target creature an opponent controls. That creature doesn't untap during its controller's next untap step.";
                  ...
                  {
                      trg.Is.Card(c => c.Is().Creature && !c.IsTapped, ControlledBy.Opponent).On.Battlefield();
