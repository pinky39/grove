    ...
    public class EphemeralShields : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
          yield return Card
            ...
            .ManaCost("{1}{W}")
            .Type("Instant")
            .Text("{Convoke} (Your creatures can help cast this spell. Each creature you tap while casting this spell pays for {1} or one mana of that creature's color.){EOL}Target creature gains indestructible until end of turn.{I}(Damage and effects that say \"destroy\" don't destroy it.){/I}")
