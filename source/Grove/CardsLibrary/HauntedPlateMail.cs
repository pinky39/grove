  ...
  public class HauntedPlateMail : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text(
          "Equipped creature gets +4/+4.{EOL}{0}: Until end of turn, Haunted Plate Mail becomes a 4/4 Spirit artifact creature that's no longer an Equipment. Activate this ability only if you control no creatures.{EOL}Equip {4}({4}: Attach to target creature you control. Equip only as a sorcery.)")
        .ActivatedAbility(p =>
          {
