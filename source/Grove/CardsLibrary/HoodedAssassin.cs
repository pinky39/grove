    ...
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .TriggeredAbility(p =>
        {
          ...
          {
            Condition = (t, g) => t.OwningCard.Controller.Opponent.Battlefield.Creatures.Any(c => g.Turn.Events.HasBeenDamaged(c)),
          });
        ...
        .TriggeredAbility(p =>
        {
          ...
          p.Trigger(new OnZoneChanged(to: Zone.Battlefield)
          {
            Condition = (t, g) => t.OwningCard.Controller.Opponent.Battlefield.Creatures.All(c => !g.Turn.Events.HasBeenDamaged(c)),
          });
