    ...
    public class ShadowcloakVampire : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
              ...
              .Text("Pay 2 life: Shadowcloak Vampire gains flying until end of turn.{I}(It can't be blocked except by creatures with flying or reach.){/I}")
              .FlavorText("\"My favorite guilty pleasure? Are there innocent ones?\"")
              .Power(4)
              .Toughness(3)
              .ActivatedAbility(p =>
              {
                  p.Text = "Pay 2 life: Shadowcloak Vampire gains flying until end of turn. (It can't be blocked except by creatures with flying or reach.)";
