  ...
  public class Quickling : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Text("{Flash} {I}(You may cast this spell any time you could cast an instant.){/I}{EOL}{Flying}{EOL}When Quickling enters the battlefield, sacrifice it unless you return another creature you control to its owner's hand.")
        .Power(2)
        .Toughness(2)
        ...
        .TriggeredAbility(p =>
        {
          ...
          p.Effect = () => new ApplyActionToPermanentOrApplyActionToOwner(
              ...
              canSelectSelf: false,
              shouldPayAi: (controller, card) => controller.Battlefield.Creatures.Count() > 1,
