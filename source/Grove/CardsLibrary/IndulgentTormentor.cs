  ...
  public class IndulgentTormentor : CardTemplateSource
  {
    public override IEnumerable<CardTemplate> GetCards()
    {
      yield return Card
        ...
        .Type("Creature — Demon")
        .Text(
          "{Flying}{EOL}At the beginning of your upkeep, draw a card unless target opponent sacrifices a creature or pays 3 life.")
        ...
        .TriggeredAbility(p =>
          {
            ...
            p.Effect = () => new SacrificeCreatureOrPayLifeOrOpponentDrawsCard(lifeAmount: 3);
