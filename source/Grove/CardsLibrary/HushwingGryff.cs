    ...
    public class HushwingGryff : CardTemplateSource
    {
        public override IEnumerable<CardTemplate> GetCards()
        {
            yield return Card
                ...
                .Text("{Flash}{I}(You may cast this spell any time you could cast an instant.){/I}{EOL}{Flying}{EOL}Creatures entering the battlefield don't cause abilities to trigger.")
