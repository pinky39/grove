namespace Grove
{
  ...
  public class TurnInfo : GameObject, IHashable
  {
    ...
    public TurnEvents PrevTurnEvents { get; private set; }
    ...
    {
      get { return _stepCount.Value; }
      private set { _stepCount.Value = value; }
    }

    public int StateCount
    {
      get { return _stateCount.Value; }
      private set { _stateCount.Value = value; }
    }
